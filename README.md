...
- **Purpose:** A collection of hand-built data structures and algorithms
	...
	educational value.
- **Architecture:** Hybrid design utilizing modern C++ paradigms (trailing return types, constexpr evaluations). 
	Core templated containers (like vector) are purely header-only, while non-templated utilities and algorithms 
	will be compiled into a static library.
...
| :--- | :--- | :--- | :--- |
| `forge::vector` | **Production Ready (v0.1.1)** | [`docs/design/vector.md`](docs/design/vector.md) | Contiguous memory, custom allocators, and constexpr optimizations for trivial types. |
